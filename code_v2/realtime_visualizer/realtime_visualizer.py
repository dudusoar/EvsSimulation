...
from realtime_visualizer.simple_websocket_server import SimpleWebSocketServer
...
class RealtimeVisualizer:
    ...
    async def _initialize_websocket_server(self):
        ...
        # SimpleWebSocketServer needs the simulation engine
        self.websocket_server = SimpleWebSocketServer(self.simulation_engine, port=8765)
